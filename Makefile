...
main.o : include/board.h include/piece.h include/move.h src/main.cpp src/board.cpp src/piece.cpp src/move.cpp
	$(CC) $(CPPFLAGS) -g -c src/main.cpp
board.o : include/board.h include/piece.h include/move.h src/board.cpp src/piece.cpp src/move.cpp
	$(CC) $(CPPFLAGS) -c src/board.cpp
piece.o: include/piece.h src/piece.cpp
	$(CC) $(CPPFLAGS) -c src/piece.cpp
move.o: include/move.h include/board.h src/move.cpp src/board.cpp
